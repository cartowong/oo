...
assertEqual(1, length(peter$fieldNames()))
assertEqual(4, length(peter$methodNames()))
...
assertEqual('xxx', amy$hiddenStudentID())
assertEqual(1, length(amy$fieldNames()))
assertEqual(5, length(amy$methodNames()))
